...
function showDedicationText() { 
  ...
  if (!text) {
    text = `Para la princesa de mi vida:\n\nTe veo y estoy totalmente seguro de que quiero que seas mi San Valentin por toda la eternidad...\n\nGracias por estar conmigo en esta etapa tan hermosa, por tu lealtad, por brindarme tu cariño, por ser tan Especial.\n\nTe amo más de lo que mis brazos y labios pueden expresar.`;  } else {
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2024-09-11T00:00:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2026-09-11T00:00:00');
